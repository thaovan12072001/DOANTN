    ...
    if (isset($_COOKIE["user"])) {
        ...
        if ($permission==1) {
            if (isset($_POST['them'])) {
                ...
                selectAll("INSERT INTO sanpham VALUES(NULL,$id_danhmuc,'$ten','$manhinh','$hedieuhanh','$cpu','$camera',$pin,$ram,'$bonho',$gia,'$anh1','$anh2','$anh3','$chitiet','$mota',0,1,$soluong)");
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name ="soluong" required class="form-control text-light"  placeholder="Nhập số lượng sản phẩm">
                      </div>
