        ...
        <div class="container">
            <div class="row justify-content-center a2">
                <div class="col-lg-8 a2">
                        <div class="a1">
                            <h2><span style="font-family: Time New Roman">Giỏ Hàng</span></h2>
                        </div>
                </div>
            </div>
        </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                foreach (selectAll("SELECT * FROM sanpham WHERE id={$item['id_sanpham']}") as $row) {
                                    $slSpById = $row['soluong'];
                                    $slTonById = $slSpById - $item['soluong'];
                                    ?>
                                <div class="media">
                                    <div class="d-flex">
...
if (isset($_POST["dathang"])) {
    ...
    if($slTonById < 0){
        echo "<script>alert('Số lượng đặt phải ít hơn tồn kho')
    </script>";
    }else{
        selectAll("UPDATE sanpham SET soluong='$slTonById' WHERE id='$idSp'");
