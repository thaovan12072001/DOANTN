        ...
        <div class="container">
            <div class="row justify-content-center a2">
                <div class="col-lg-8 a2">
                        <div class="a1">
                            <h2 class="addfont"><span style="font-family: Time New Roman">Chi Tiết Sản Phẩm</span></h2>
                        </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-5 col-xl-4">
                                <div class="s_product_text">
                                    ...
                                    <ul class="list">
                                        ...
                                        <li>
                                            <a class="active" href="#">
                                                <span>Sẵn hàng</span> : <?= $soluong ?></a>
                                        </li>
                                        <?php }else { ?>
                                            <li>
                                            <a class="active" href="category.php?id=<?= $item['id_danhmuc'] ?>">
                                                <span style="color:red">Đã bán hết</span></a>
                                            </li>
                                        <?php } ?>
                                    </ul>
                                    <p>
                                    ...
                                    <form class="card_area d-flex justify-content-between align-items-center" action="" method="POST">
                                        <div class="product_count">
                                            ...
                                            <input class="input-number" name="soluong" type="number" value="1" min="1" max="20" readonly>
